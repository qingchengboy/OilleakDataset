...
class BaseTrainer:
    ...
    def _setup_train(self, world_size):
        ...
        self.train_loader = self.get_dataloader(self.trainset, self.trainirset,batch_size=batch_size, rank=LOCAL_RANK, mode="train")
        if RANK in {-1, 0}:
    ...
    def get_dataset(self):
        ...
        self.data = data
        return data["train"], data.get("val"),data["train_ir"],data.get("val_ir")
